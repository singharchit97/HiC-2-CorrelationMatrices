...
process pearsonMatrices_cool {
    ...
    output:
    file 'GM12878_chr1_2_pearson_500000.cool' into txtFile_ch
...
process pearsonMatrices_txt{
    ...
    output:
    file 'GM12878_chr1_2_pearson_500kb.txt' into final_ch

    shell:
    '''
    cooler dump --join !{z} > "GM12878_chr1_2_pearson_500kb.txt"
